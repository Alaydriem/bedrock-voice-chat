...
// renderer reads a position and a whispering flag back out of it. Losing the flag records a
// whispering speaker at full range, which is a silent wrong answer in an exported recording.
#[test]
fn a_whispering_speaker_is_recorded_as_whispering() {
    ...
    assert!(synthesised.is_whispering());
}
