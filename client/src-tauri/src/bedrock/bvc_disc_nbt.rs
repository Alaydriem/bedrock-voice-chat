...
mod tests {
    ...
    fn extracts_valid_uuid_from_blob() {
        ...
        let extracted = BvcDiscNbt::extract_audio_id(&Bytes::from(blob));
    ...
    fn returns_none_when_marker_missing() {
        ...
        assert!(BvcDiscNbt::extract_audio_id(&blob).is_none());
    }
    ...
    fn returns_none_for_invalid_uuid() {
        ...
        assert!(BvcDiscNbt::extract_audio_id(&Bytes::from(blob)).is_none());
    }
