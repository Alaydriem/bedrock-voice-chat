  ...
  static get DEFINITIONS(): Readonly<Record<string, FaultDefinition>> {
    return {
      PERM1: {
        ...
        hint: I18n.t("Granted in your system settings, not here"),
      ...
      PERM2: {
        ...
        caption: I18n.t("NOT PERMITTED"),
        label: I18n.t("Can't start"),
        hint: I18n.t("Background audio depends on this"),
        primaryAction: { label: I18n.t("Back to Dashboard"), url: "/dashboard" },
      },
      SERV01: {
        code: "SERV01",
        ...
        label: I18n.t("Can't start"),
        hint: I18n.t("Battery optimisation is the usual cause"),
      ...
      AUDI01: {
        ...
        label: I18n.t("Can't start"),
        hint: I18n.t("48kHz is the sample rate to look for"),
      ...
      AUDI02: {
        ...
        label: I18n.t("Can't start"),
        hint: I18n.t("A muted or unplugged headset is the usual cause"),
        primaryAction: { label: I18n.t("Try Again"), url: "/dashboard" },
      ...
      VER01: {
        ...
        // The same two English words caption both version faults. Separated by context
        // because the implied noun differs, and languages that inflect an adjective to
        // agree with it need two translations.
        caption: I18n.tc("client", "TOO OLD"),
        label: I18n.t("Incompatible"),
        hint: I18n.t("The server is newer than this client"),
        primaryAction: { label: I18n.t("Back to Dashboard"), url: "/dashboard" },
      },
      VER02: {
        code: "VER02",
        ...
        label: I18n.t("Incompatible"),
        hint: I18n.t("Only the server owner can fix this one"),
      ...
      DNS01: {
        ...
        hint: I18n.t("A typo in the address is the usual cause"),
        primaryAction: { label: I18n.t("Try Again"), url: "/dashboard" },
      ...
      QUIC01: {
        ...
        label: I18n.t("Not connected"),
        hint: I18n.t("HTTP got through; UDP did not"),
        primaryAction: { label: I18n.t("Try Again"), url: "/dashboard" },
        secondaryAction: { label: I18n.t("Choose Different Server"), url: "/" },
      },
      CONN01: {
        ...
        label: I18n.t("Not connected"),
        hint: I18n.t("A server that is not running answers exactly like this"),
        primaryAction: { label: I18n.t("Try Again"), url: "/dashboard" },
        secondaryAction: { label: I18n.t("Choose Different Server"), url: "/" },
      },
      AUTH01: {
        ...
        hint: I18n.t("Signing in again issues fresh credentials"),
      ...
      CERT01: {
        ...
        hint: I18n.t("Only the server owner can fix the certificate"),
        primaryAction: { label: I18n.t("Sign In Again"), url: "/login" },
        secondaryAction: { label: I18n.t("Choose Different Server"), url: "/" },
      },
      CERT02: {
        ...
        caption: I18n.t("UNTRUSTED"),
        label: I18n.t("Not connected"),
        hint: I18n.t("Your sign-in is fine; the server's certificate is not"),
        primaryAction: { label: I18n.t("Try Again"), url: "/dashboard" },
        secondaryAction: { label: I18n.t("Choose Different Server"), url: "/" },
      },
      UPD01: {
      ...
      DEFAULT: {
        ...
        hint: I18n.t("The code above is what support will ask for"),
