...
description: "Multi-track recording, Stream Deck control, and the local WebSocket API."
source: https://www.bedrockvoicechat.com/wiki/creator/
---
...
| Page | What it covers |
|---|---|
| [Recording](/wiki/creator/recording/) | Capture a session and export per-player tracks as BWAV or MP4/Opus. |
