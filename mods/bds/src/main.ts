...
import { AudioPlayerManager } from './audio/audio-player-manager';
import { registerAudioComponents } from './audio/components';
...
registerAudioComponents(audioManager, getWorldUuid);

// Register custom commands (cheats not required)
registerCommands(bvc_server, access_token);
